...
kobe = Specialty.new(name: 'Boeuf de Kobe', description: "Tu as sûrement déjà entendu parler du bœuf de Kobé ? Si non, sache que c'est la crème de la crème en matière de bœuf. On raconte même que les bêtes seraient massés et nourris à la bière. Evidemment, le prix suit aussi cette réputation de luxe. Il y a plusieurs classifications, à toi de choisir selon tes goûts... et ton budget.", country: 'Japon', region: 'Kansai', city: "Kobé", category_list: "Viande", timetoeat_list: "Déjeuner/ Dîner", game: 100)
...
inarizushi = Specialty.new(name: 'Inarizushi', description: "Les inarizushi sont constitués d'une poche de tofu frit sucré et remplie de riz vinaigré. Ils ont été inventés à Tokyo par un chef qui souhaitait les associer aux temples inari (dédiés à la déesse de la croissance du riz).", country: "Japon", region: "Kanto", city: "Tokyo", category_list: "Riz, Friture" , timetoeat_list: "Déjeuner/Dîner", game: 100)
...
fugu = Specialty.new(name: 'Fugu', description: "Tu es un food trotter intrépide ? Le fugu, aussi appelé poisson globe contient un poison mortel. Il doit être vidé et débarrassé de ses parties toxiques par un chef spécialisé et possédant une licence. Il est généralement dégusté en sashimi. Attention, c'est un mets plutôt cher.", country: "Japon", region: "Kansai", city: "Osaka", category_list: "Poisson" , timetoeat_list: "Déjeuner/Dîner", game: 100)
fugu.remote_photo_url = url
fugu.save

url = 'https://res.cloudinary.com/geraldinefd/image/upload/v1575825291/poulpy.jpg'
poulpy = Specialty.new(name: 'Sucette de poulpe', description: "Elle sont généralement laquées à la sauce soja avec... un oeuf de caille dans la tête. Elles se trouvent facilement sur les marchés d'Osaka.", country: "Japon", region: 'Kansai', city: "Osaka", category_list: "Snack" , timetoeat_list: "Goûter", game: 100)
poulpy.remote_photo_url = url
poulpy.save

url = 'https://res.cloudinary.com/geraldinefd/image/upload/v1575819209/kushikatsu.jpg'
kushikatsu = Specialty.new(name: 'Kushikatsu', description: "Des fritures typiques d'Osaka au boeuf, porc, poulet, fruits de mer ou légumes. Elles sont en général servies sur des batônnets avec de la sauce Worcestshire. C'était un plat populaire pendant la guerre et il reste un des emblèmes de la street food aujourd'hui.", country: "Japon", region: 'Kansai', city: "Osaka", category_list: "Viande, Fruits de mer, Street food, Friture" , timetoeat_list: "Déjeuner/Dîner", game: 100)
kushikatsu.remote_photo_url = url
kushikatsu.save

url = 'https://res.cloudinary.com/geraldinefd/image/upload/v1575825687/ochazuke.jpg'
ochazuke = Specialty.new(name: 'Ochazuke', description: "Un plat très simple qui se prépare en versant de l'eau chaude ou du thé vert sur un bol de riz. Il peut être agrémenté de sésame ou poisson. Attention, si on vous le propose à Kyoto c'est probablement parce que vous avez abusé de l'hospitalité de vos hôtes et qu'on vous demande poliment de partir.", country: "Japon", region: 'Kansai', city: "Kyoto", category_list: "Riz" , timetoeat_list: "Déjeuner/Dîner", game: 100)
